// -----------------------------------------------------------------------------
//  <copyright file="AbstractPhxSetTests.cs" company="Star Cruise Studios LLC">
...
namespace Phx.Collections {
    ...
    public abstract class AbstractPhxSetTests : AbstractPhxCollectionsTestBase {
        private void SetComparisonTestCase(
                int numElements,
                int minOtherElement,
                int numOtherElements,
                string when,
                Func<IPhxSet<string>, IEnumerable<string>, bool> action,
                bool expectedResult
        ) {
        ...
        public void BinarySetOperationTest(
                ...
                string when,
                Func<IPhxSet<string>, IEnumerable<string>, IPhxSet<string>> action) {
