...
namespace Phx.Lang {
    ...
    public static class StringExtensions {
        ...
        ///     <see cref="IDisplay.ToDisplay()" /> method. Otherwise, it will use the instance's <see cref="object.ToString()" />
        ///     method.
        /// </remarks>
        ...
        ///     <see cref="IDisplay" /> interface, this will use the <see cref="IDisplay.ToDisplay()" /> method. Otherwise, it will
        ///     use the instance's <see cref="object.ToString()" /> method.
        /// </remarks>
        ...
        /// <summary> Converts a string from a caps case string to Pascal case. </summary>
        /// <remarks>
