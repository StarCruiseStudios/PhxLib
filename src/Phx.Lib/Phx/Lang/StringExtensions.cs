...
namespace Phx.Lang {
    ...
    public static class StringExtensions {
        /// <summary>
        ///     Returns a string that represents the current object and is safe to call on a null
        ///     instance.
        /// </summary>
        /// <param name="obj"> The object to convert to a string. </param>
        /// <returns>
        ///     A string that represents the current object or the <see cref="StringUtils.NullString" />
        ...
        /// <remarks>
        ///     This only affects strings that begin with a letter. Strings that begin with non-letter
        ...
        /// <remarks>
        ///     This will only remove the "I" as a prefix and will not affect words that simply begin
        ///     with "I". e.g. ICar => Car, Car => Car, IInput => Input, Input => Input
        /// </remarks>
        /// <param name="input"> The input string. </param>
