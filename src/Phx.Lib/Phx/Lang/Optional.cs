...
namespace Phx.Lang {
    ...
    public struct Optional<T> where T : notnull {
        ...
        /// <summary> Gets a value indicating whether the <see cref="Optional{T}" /> contains a value. </summary>
        /// <value> <c> true </c> when a value is present, otherwise <c> false </c>. </value>
        public bool IsPresent { get; }

        /// <summary> Gets a value indicating whether the <see cref="Optional{T}" /> does not contain a value. </summary>
        ...
        /// <summary> Invokes the specified action if no value is contained in the <see cref="Optional{T}" />. </summary>
        /// <param name="action"> The action to invoke. </param>
        ...
        /// <summary> Returns an <see cref="Optional{T}" /> with the provided value. </summary>
        ...
        /// <summary> An empty <see cref="Optional{T}" /> of type <typeparamref name="T" />. </summary>
