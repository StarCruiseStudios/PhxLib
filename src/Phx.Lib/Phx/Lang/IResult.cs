...
namespace Phx.Lang {
    ...
    public interface IResult<out T, out E> {
        ...
        /// <summary> Indicates whether the <see cref="IResult{T, E}" /> is successful, and contains the given successful value. </summary>
        /// <param name="predicate"> The predicate that defines the expected successful value. </param>
        /// <returns>
        ///     <c>true</c> if the result is successful and the given predicate succeeds, otherwise <c>false</c>.
        /// </returns>
        bool Contains(Func<T, bool> predicate);
        
        /// <summary> Indicates whether the <see cref="IResult{T, E}" /> failed, and contains the given error value. </summary>
        ...
        /// <returns>
        ///     <c>true</c> if the result failed and the given predicate succeeds, otherwise <c>false</c>.
        /// </returns>
        bool ContainsError(Func<E, bool> predicate);
        
        /// <summary>
        ///     Maps a <see cref="IResult{T, E}" /> instance to an instance of type <see cref="IResult{T2, E}" /> using the
        ///     provided converter function on a successful value.
        /// </summary>
        /// <remarks>
        ///     The converter function is only used if the <see cref="IResult{T, E}" /> is a successful value. A failed result
        ...
        /// <summary>
        ///     Maps a <see cref="IResult{T, E}" /> instance to an instance of type <see cref="IResult{T, E2}" /> using the
        ///     provided converter function on a failure value.
        /// </summary>
        /// <remarks>
        ///     The converter function is only used if the <see cref="IResult{T, E}" /> is a failure value. A successful
        ...
        /// <summary>
        ///     Returns the result value contained in the <see cref="IResult{T, E}" /> if it was successful, otherwise throws
    ...
    /// <summary>
    /// Defines extension methods for the <see cref="IResult{T,E}"/> type.
    /// </summary>
    public static class IResultExtensions {
        /// <summary>
        ///     Returns the result value contained in the <see cref="IResult{T, E}" /> if it was successful, otherwise returns
