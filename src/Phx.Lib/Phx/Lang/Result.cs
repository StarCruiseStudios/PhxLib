...
{
    /// <summary>
    ///     Represents the successful or unsuccessful result of an operation.
    /// </summary>
    ...
    public abstract class Result<T, E>
    {
        ...
        /// <summary>
        ///     Indicates whether the <see cref="Result{T, E}"/> is successful, and contains the given successful value.
        /// </summary>
        /// <param name="expected">The expected successful value.</param>
        /// <returns> <c>true</c> if the result is successful and contains the given value, or <c>false</c> if the
        ///           operation failed, or contains a different result. </returns>
        /// <remarks> This method compares the successful result to the given value using <c>Object.Equals()</c>.
        ///           </remarks>
        public bool Contains(T expected)
        {
            return this is Success<T, E> s
                && Object.Equals(s.Result, expected);
        }

        /// <summary>
        ///     Indicates whether the <see cref="Result{T, E}"/> failed, and contains the given error value.
        /// </summary>
        /// <remarks>
        ...
        /// <returns> <c>true</c> if the result failed and contains the given value, or <c>false</c> if the operation
        ///           succeeded, or contains a different error. </returns>
        public bool ContainsError(E expected)
        {
            return this is Failure<T, E> f
                && Object.Equals(f.Error, expected);
        }
        ...
        /// </summary>
        /// <remarks>
        ///     The converter function is only used if the <see cref="Result{T, E}"/> is a successful value. A failed
        ///     result will pass the error type unchanged.
        /// </remarks>
...
#pragma warning restore RCS1140
        ...
        /// <summary>
        ///     Returns the result value contained in the <see cref="Result{T, E}"/> if it was successful, otherwise
        ///     returns the provided default value.
        /// </summary>
        /// <param name="defaultValue"> The alternative value in cases when the <see cref="Result{T, E}"/> is a failure.
        ///                             </param>
        /// <returns> A <typeparamref name="T"/> instance retrieved from the result or the provided default value.
        ///           </returns>
        ...
        /// </summary>
        /// <param name="provideAlternative"> The function that provides the alternative value in cases when the
        ///                                   <see cref="Result{T, E}"/> is a failure. </param>
        /// <returns> A <typeparamref name="T"/> instance retrieved from the result or constructed using the given
...
#pragma warning restore RCS1140
        ...
        /// <summary>
        ///     Returns the result value contained in the <see cref="Result{T, E}"/> if it was successful, otherwise
        ///     throws the exception provided by the given provider function.
        /// </summary>
        /// <typeparam name="Ex"> The type of exception that will be thrown. </typeparam>
        /// <param name="provideException"> The function that provides the exception to throw in cases when the
        ///                                 <see cref="Result{T, E}"/> is a failure. </param>
    ...
    /// <summary>
    ///     Contains static and extesion functions for the <see cref="Result{T, E}"/> class.
    /// </summary>
    public static class Result
    {
        /// <summary>
        ///     Constructs a new Success <see cref="Result{T, E}"/> instance containing the given result value.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
        ...
        /// <summary>
        ///     Constructs a new Success <see cref="Result{Unit, E}"/> instance.
        /// </summary>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
        ...
        /// <summary>
        ///     Constructs a new Success <see cref="Result{Unit, Exception}"/> instance.
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new Success <see cref="Result{T, Exception}"/> instance containing the given result value.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <param name="result"> The result. </param>
        ...
        /// <summary>
        ///  Constructs a new Failure <see cref="Result{T, E}"/> instance containing the given error value.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
        ...
        /// <summary>
        ///     Constructs a new Failure <see cref="Result{Unit, E}"/> instance containing the given error value.
        /// </summary>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
        /// <param name="error"> The error. </param>
        ...
        /// <summary>
        ///     Constructs a new Failure <see cref="Result{Unit, Exception}"/> instance containing the given error
        ///     value.
        /// </summary>
        /// <param name="error"> The error. </param>
        ...
        /// <summary>
        ///     Constructs a new Failure <see cref="Result{T, Exception}"/> instance containing the given error value.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <param name="error"> The error. </param>
        ...
        /// <summary>
        ///     Returns the result value contained in the <see cref="Result{T, E}"/> if it was successful, otherwise
        ///     throws the exception contained by the failure result.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
...
#pragma warning restore RCS1140
        ...
        /// <summary>
        ///     Returns the result value contained in the <see cref="Result{T, E}"/> if it was successful, otherwise
        ///     throws the an exception containing the error code from the failure result.
        /// </summary>
        /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
        /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
        /// <param name="result"> The <see cref="Result{T, E}"/> instance the check is performed on. </param>
...
#pragma warning restore RCS1140
    ...
    {
        /// <summary>
        ///     Gets the result of the successful operation.
        /// </summary>
    ...
    /// <summary>
    ///     Represents the unsuccessful result of an operation.
    /// </summary>
    /// <seealso cref="Result{T, E}" />
    /// <typeparam name="T"> The type of the value returned on operation success. </typeparam>
    /// <typeparam name="E"> The type of the value returned on operation failure. </typeparam>
    ...
    {
        /// <summary>
        ///     Gets the error that caused the unsuccessful completion of the operation.
        /// </summary>
        /// <remarks>
        ///     Typically, this will be an exception indicating the error that occurred, but could also be an error
        ///     message string, an integer or enum error code, or a more complex type that represents the error details.
        /// </remarks>
