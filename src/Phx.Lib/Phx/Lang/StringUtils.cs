...
namespace Phx.Lang {
    ...
    public static class StringUtils {
        ...
        /// <remarks>
        ///     <see cref="string.Empty" /> is a static readonly value, not a constant, so it cannot be
        ///     used in certain contexts such as annotation arguments or switch statements.
        /// </remarks>
