...
{
    /// <summary>
    ///     Provides utilities for working with the <see cref="string"/> class.
    /// </summary>
    public static class StringUtils
    {
        /// <summary>
        ///     A string representation of the <c>null</c> value.
        /// </summary>
        public const string NullString = "[null]";

        /// <summary>
        ///     A constant value empty string.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Converts a string from caps case to pascal case.
        /// </summary>
        /// <remarks>
        ...
        {
            if (!StringUtils.IsCapsCase(capsString))
            {
