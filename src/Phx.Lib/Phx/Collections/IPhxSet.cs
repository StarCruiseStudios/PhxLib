// -----------------------------------------------------------------------------
//  <copyright file="IPhxSet.cs" company="DangerDan9631">
...
namespace Phx.Collections {
    /// <summary>
    ///     Represents an <see cref="IPhxCollection{T}"/> whose elements are unique.
    /// </summary>
    /// <typeparam name="T"> The type of the elements contained in the <see cref="IPhxSet{T}"/>. </typeparam>
    public interface IPhxSet<T> : IPhxCollection<T> {
        /// <summary>
        ///     Gets a value indicating if this set of items is equivalent to the set of items contained in the given
        ///     collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        /// <returns> <c>true</c> if the set of items is equivalent to the given set, otherwise <c>false</c>. </returns>
        public bool IsEquivalent(IEnumerable<T> other);

        /// <summary>
        ///     Gets a value indicating if this set of items is contained in the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        /// <returns> <c>true</c> if all of the items in this set are contained in the given collection, otherwise
        ///           <c>false</c>. </returns>
        public bool IsSubsetOf(IEnumerable<T> other);

        /// <summary>
        ///     Gets a value indicating if this set of items is contained in the given collection, and the sets are not
        ///     equivalent.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        /// <returns> <c>true</c> if all of the items in this set are contained in the given collection and the
        ///           collections are not equivalent, otherwise <c>false</c>. </returns>
        public bool IsProperSubsetOf(IEnumerable<T> other);

        /// <summary>
        ///     Gets a value indicating if this set of items contains all of the items in the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        /// <returns> <c>true</c> if all of the items in the given set are contained in this collection, otherwise
        ///           <c>false</c>. </returns>
        public bool IsSupersetOf(IEnumerable<T> other);

        /// <summary>
        ///     Gets a value indicating if this set of items contains all of the items in the given collection, and the
        ///     sets are not equivalent.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        /// <returns> <c>true</c> if all of the items in the given set are contained in this collection and the
        ///           collections are not equivalent, otherwise <c>false</c>. </returns>
        public bool IsProperSupersetOf(IEnumerable<T> other);

        /// <summary>
        ///     Gets a set containing all subsets of this set.
        /// </summary>
        /// <returns> The powerset of all subsets of this set. </returns>
        public IPhxSet<IPhxSet<T>> GetPowerSet();

        /// <summary>
        ///     Gets a new set that contains all elements that are in this set and not in the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        ...
        /// <summary>
        ///     Gets a new set that contains all elements that are in only one of this set and the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        ...
        /// <summary>
        ///     Gets a new set that contains all elements that are in both this set and the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
        ...
        /// <summary>
        ///     Gets a new set that contains all elements that are in either this set or the given collection.
        /// </summary>
        /// <param name="other"> The collection of items to compare to this one. </param>
    ...
    /// <summary>
    ///     Contains extension methods applied to all implementations of <see cref="IPhxSet{T}"/>.
    /// </summary>
