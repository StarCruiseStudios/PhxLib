...
namespace Phx.Collections {
    ...
    public sealed class ImmutablePhxMap<TKey, TValue> : IPhxMap<TKey, TValue>, IDebugDisplay {
        ...
        /// <inheritdoc />
        public IPhxCollection<IPhxPair<TKey, TValue>> Entries => new PhxHashSet<IPhxPair<TKey, TValue>>(
            from kvp in internalMap.CopyToPhxSet()
            select new PhxPair<TKey, TValue>(kvp.Key, kvp.Value));
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ImmutablePhxMap{TKey, TValue}"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="elements"> The elements to initialize the collection with. </param>
        public ImmutablePhxMap(IEnumerable<IPhxPair<TKey, TValue>> elements) {
        ...
        /// </summary>
        /// <param name="elements"> The elements to initialize the collection with. </param>
        public ImmutablePhxMap(params IPhxPair<TKey, TValue>[] elements) : this(elements.AsEnumerable()) { }
