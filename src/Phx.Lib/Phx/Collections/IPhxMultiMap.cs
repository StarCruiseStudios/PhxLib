...
namespace Phx.Collections {
    ...
    /// <summary>
    ///     Represents a collection of mappings from keys to one or more values.
    /// </summary>
    ...
    public interface IPhxMultiMap<TKey, out TValue> {
        /// <summary>
        ...
        /// </summary>
        public IPhxCollection<IPhxPair<TKey, IPhxCollection<TValue>>> Entries { get; }

        /// <summary>
        ///     Gets the set of keys contained in this <see cref="IPhxMultiMap{TKey, TValue}"/> instance.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the number of keys contained in the <see cref="IPhxMultiMap{TKey, TValue}"/>.
        /// </summary>
        public int KeyCount { get; }

        /// <summary>
        ///     Gets the number of elements contained in all keys in the <see cref="IPhxMultiMap{TKey, TValue}"/>.
        /// </summary>
        public int ElementCount { get; }

        /// <summary>
        ///    Returns a value indicating whether this <see cref="IPhxMultiMap{TKey, TValue}"/> contains
        ///    any values associated with the given key.
        /// </summary>
        /// <param name="key"> The key. </param>
        ...
        /// </summary>
        /// <param name="key"> The key. </param>
        /// <returns> A success result containing the collection of values associated with the key if found, or a
        ///           failure result if the key is not found. </returns>
        public IResult<IPhxCollection<TValue>, Unit> Get(TKey key);
    }

    /// <summary>
    ///     Contains extension methods applied to all implementations of <see cref="IPhxMultiMap{TKey, TValue}"/>.
    /// </summary>
    public static class IPhxMultiMapExtensions {
        /// <summary>
        ///     Gets the elements associated with the specified key if any exist, or else returns the value provided by
        ...
        /// <summary>
        ///     Gets the first element associated with the specified key if any exist, or else returns the value
        ...
        /// <returns> A <typeparamref name="TValue"/> instance retrieved from the map. </returns>
        /// <exception cref="InvalidOperationException"> Thrown if the key is not found in the map. </exception>
        public static TValue GetFirstValue<TKey, TValue>(this IPhxMultiMap<TKey, TValue> map, TKey key) {
            return (map.Get(key) is Success<IPhxCollection<TValue>, Unit> s && s.Result.IsNotEmpty())
                ? s.Result.First()
