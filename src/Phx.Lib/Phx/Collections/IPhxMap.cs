...
namespace Phx.Collections {
    ...
    public interface IPhxMap<TKey, out TValue> : IPhxContainer<IPhxKeyValuePair<TKey, TValue>> {
        /// <summary>
        ...
        /// </summary>
        public IPhxCollection<IPhxKeyValuePair<TKey, TValue>> Entries { get; }

        /// <summary> Gets the set of keys contained in this <see cref="IPhxMap{TKey, TValue}" /> instance. </summary>
        public IPhxSet<TKey> Keys { get; }

        /// <summary>
        ///     Gets a collection of all values contained in this <see cref="IPhxMap{TKey, TValue}" />
        ///     instance.
        /// </summary>
        public IPhxCollection<TValue> Values { get; }

        /// <summary>
        ///     Returns a value indicating whether this <see cref="IPhxMap{TKey, TValue}" /> contains a
    ...
    public static class IPhxMapExtensions {
        /// <summary>
        ///     Gets the element associated with the specified key if one exists, or else returns the
        ...
        public static TValue GetOrElse<TKey, TValue>(
                ...
                TKey key,
                Func<TValue> alternateValue) {
            return map.Get(key).OrElse(alternateValue);
        }
