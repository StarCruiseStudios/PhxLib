// -----------------------------------------------------------------------------
//  <copyright file="IMutablePhxMap.cs" company="Star Cruise Studios LLC">
...
namespace Phx.Collections {
    ...
    /// <summary>
    ///     Represents a mutable collection of key value pairs.
    /// </summary>
    ...
    public interface IMutablePhxMap<TKey, TValue> : IPhxMap<TKey, TValue> {
        /// <summary>
        ///     Adds or updates the value associated with the specified key, gets the value if one exists, or else
        ...
        /// <summary>
        ///     Removes all elements from the <see cref="IMutablePhxMap{TKey, TValue}"/>.
        /// </summary>
        public void Clear();
        ...
        ///           <see cref="IMutablePhxMap{TKey, TValue}"/>. </returns>
        public bool Remove(TKey key);

        /// <summary>
        ///     Removes all of the specified keys from the <see cref="IMutablePhxMap{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Removes all values from the <see cref="IMutablePhxMap{TKey, TValue}"/> that match the given predicate.
        /// </summary>
        /// <param name="predicate"> The predicate that returns <c>true</c> for all values that should be removed.
        ///                          </param>
        ...
        /// <summary>
        ///     Removes all values from the <see cref="IMutablePhxMap{TKey, TValue}"/> except for the keys contained in
        ...
        /// <summary>
        ///     Removes all values from the <see cref="IMutablePhxMap{TKey, TValue}"/> except for those that match the
        ///     given predicate.
        /// </summary>
        /// <param name="predicate"> The predicate that returns <c>true</c> for all elements that should be retained.
        ///                          </param>
        /// <returns> The number of elements that were removed by the operation. </returns>
        ...
        /// <summary>
        ///     Adds or updates the value associated with each of the specified keys.
        /// </summary>
    ...
    /// </summary>
    public static class IMutablePhxMapExtensions {
        /// <summary>
        ///     Gets the element associated with the specified key if one exists, or else inserts and returns the
        ...
        ///           </returns>
        public static TValue GetOrInsert<TKey, TValue>(this IMutablePhxMap<TKey, TValue> map, TKey key, TValue defaultValue) {
        ...
        /// <summary>
        ///     Gets the element associated with the specified key if one exists, or else inserts and returns the value
        ///     provided by the given provider function.
        /// </summary>
        /// <typeparam name="TKey"> The type of object used as a key. </typeparam>
        /// <typeparam name="TValue"> The type of object used as a value. </typeparam>
        /// <param name="map"> The collection to perform the operation on. </param>
        ...
        public static TValue GetOrInsert<TKey, TValue>(
            this IMutablePhxMap<TKey, TValue> map, TKey key, Func<TValue> defaultValue
        ) {
            return map.Get(key).OrElse(() => {
                var d = defaultValue();
                map.Set(key, d);
        ...
        /// <param name="keys"> The keys to remove. </param>
        /// <returns> The number of keys that were removed by the operation. </returns>
        public static int RemoveAll<TKey, TValue>(this IMutablePhxMap<TKey, TValue> map, params TKey[] keys) {
        ...
        /// <param name="keys"> The keys to retain. </param>
        /// <returns> The number of keys that were removed by the operation. </returns>
        public static int RetainOnly<TKey, TValue>(this IMutablePhxMap<TKey, TValue> map, params TKey[] keys) {
        ...
        /// <param name="map"> The collection to perform the operation on. </param>
        /// <param name="values"> A collection of the key value pairs to set. </param>
        public static void SetAll<TKey, TValue>(this IMutablePhxMap<TKey, TValue> map, params (TKey, TValue)[] values) {
